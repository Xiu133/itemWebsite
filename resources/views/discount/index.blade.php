  ...
  <div id="app">
    ...
    <header :class="{ scrolled: isScrolled }">
      <div class="header-inner">
        ...
        <nav>
          <a href="{{ route('discount.index') }}" style="color: var(--accent);">限時優惠</a>
    ...
    <section class="discount-header">
      <div class="discount-header-content">
        <p class="discount-eyebrow">
          <svg viewBox="0 0 24 24"><path d="M12 2 L2 7 L12 12 L22 7 Z"/><path d="M2 17 L12 22 L22 17"/><path d="M2 12 L12 17 L22 12"/></svg>
          Limited Time Offer
        </p>
        <h1 class="discount-title">限時<em>優惠</em></h1>
        <p class="discount-desc">精選特價商品，為您帶來超值優惠。把握機會，為生活添加質感好物。</p>
    ...
    <section class="filter-section">
      <div class="filter-inner">
        ...
        <div class="filter-count">
          共 @{{ filteredProducts.length }} 件特價商品
        </div>
      </div>
    </section>
      ...
      <div v-else class="products-grid">
        <div class="product-card" v-for="product in filteredProducts" :key="product.id">
          <div class="product-image">
            ...
            <span class="product-tag sale">特價</span>
            <span class="discount-badge" v-if="product.discountPercent">-@{{ product.discountPercent }}%</span>
          ...
          <div class="product-info">
            ...
            <p class="product-price">
              ...
              <span class="sale">NT$ @{{ product.price.toLocaleString() }}</span>
            </p>
            <p class="product-savings" v-if="product.originalPrice">
