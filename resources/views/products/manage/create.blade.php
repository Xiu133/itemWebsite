...
<head>
    ...
    @vite(['resources/css/ecommerce/style.css', 'resources/css/merchant/dashboard.css', 'resources/css/product/create.css', 'resources/js/product/create.js'])
</head>
<body>
    <!-- Header -->
    <header>
    ...
    <main class="dashboard-page">
        <div class="dashboard-container" style="max-width: 800px;">
            ...
            <!-- Form Section -->
            <form class="form-section" method="POST" action="{{ route('my-products.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-input" placeholder="輸入商品名稱" value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-input form-textarea" placeholder="描述您的商品特色...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="form-error">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="price" class="form-input" placeholder="0" value="{{ old('price') }}" min="0" step="1" required>
                            @error('price')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="original_price" class="form-input" placeholder="0" value="{{ old('original_price') }}" min="0" step="1">
                    ...
                    <div class="form-group">
                        <div class="form-checkbox">
                            ...
                            <label for="is_active">立即上架</label>
                        </div>
                    </div>
                </div>
